...
* Category screen, where user can choose challenge category( Mountains, Monuments or Long distances). Top 5 location can be seen in
  scrollable horizontal list of each category with the image and step number .
...
* Avilable challenges of choosen category can be seen in detail screen.
